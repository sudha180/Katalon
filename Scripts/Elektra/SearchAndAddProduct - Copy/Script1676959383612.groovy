...
/*
 * Actions action = new Actions(driver); action.sendKeys(Keys.F12);
 */
//WebUI.sendKeys(Keys.F12)
WebUI.sendKeys('hello', Keys.F12)
...
WebUI.click(findTestObject('Object Repository/ElektraPage/CartPage/bagIcon_header'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/ElektraPage/CartPage/continuar_minicart'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/CheckoutPage/checkoutPagesBreadCrumb_checkout'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/CheckoutPage/checkCartEnabled_checkout'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/CheckoutPage/verifyEmailDisabled_checkout'), 0)
